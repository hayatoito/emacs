...
(setq package--builtins '(
  ...
  (c-ts-common . [nil nil "Utilities for C like Languages"])
  ...
  (eldoc . [(1 13 0) nil "Show function arglist or variable docstring in echo area"])
  ...
  (emacs . [(29 1) nil "the extensible text editor"])
  ...
  (erc . [(5 5 0 29 1) nil "An Emacs Internet Relay Chat client"])
  ...
  (eudc-capf . [nil nil "EUDC - completion-at-point bindings"])
  (eudcb-ecomplete . [nil nil "EUDC - ecomplete backend"])
  (eudcb-macos-contacts . [nil nil "EUDC - macOS Contacts backend"])
  (eudcb-mailabbrev . [nil nil "EUDC - mailabbrev backend"])
  ...
  (ietf-drums-date . [nil nil "parse time/date for ietf-drums.el"])
  ...
  (image-dired-dired . [nil nil "Dired specific commands for Image-Dired"])
  (image-dired-external . [nil nil "External process support for Image-Dired"])
  (image-dired-tags . [nil nil "Tag support for Image-Dired"])
  (image-dired-util . [nil nil "util functions for Image-Dired"])
  ...
  (jsonrpc . [(1 0 16) nil "JSON-RPC library"])
  (kermit . [nil nil "additions to shell mode for use with kermit"])
  (keymap . [nil nil "Keymap functions"])
  ...
  (oclosure . [nil nil "Open Closures"])
  ...
  (org . [(9 6 6) nil "Outline-based notes management and organizer"])
  ...
  (project . [(0 9 8) nil "Operations on the current project"])
  ...
  (soap-client . [(3 2 1) nil "Access SOAP web services"])
  ...
  (use-package . [(2 4 5) nil "A configuration macro for simplifying your .emacs"])
  (use-package-bind-key . [nil nil "Support for the :bind/:bind-keymap keywords"])
  (use-package-core . [nil nil "A configuration macro for simplifying your .emacs"])
  (use-package-delight . [nil nil "Support for the :delight keyword"])
  (use-package-diminish . [nil nil "Support for the :diminish keyword"])
  (use-package-ensure . [nil nil "Support for the :ensure and :pin keywords"])
  (use-package-ensure-system-package . [(0 2) nil "auto install system packages"])
  (use-package-jump . [nil nil "Attempt to jump to a use-package declaration"])
  (use-package-lint . [nil nil "Attempt to find errors in use-package declarations"])
  ...
  (verilog-mode . [(2021 10 14 127365406) nil "major mode for editing verilog source in Emacs"])
  ...
  (xref . [(1 6 3) nil "Cross-referencing commands"])
